...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (TD(0),        Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
...
void tapDanceAction(uint8_t tap_dance_index, byte row, byte col, uint8_t tap_count, kaleidoscope::TapDance::ActionType tap_dance_action) {
  switch (tap_dance_index) {
    case 0:
      return tapDanceActionKeys(tap_count, tap_dance_action, Key_Escape, M(MACRO_CTRL_B));
  }
}
